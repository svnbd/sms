...
$id = $_GET['id'];
$data = mysqli_query($conn, "SELECT * FROM add_student WHERE id=$id");
...
if(isset($_POST['update'])){
    ...
    $sql = "UPDATE add_student SET name='$name', email='$email', phone='$phone', department='$department', created_at='$created_at', updated_at='$updated_at' WHERE id=$id";
